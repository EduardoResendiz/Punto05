...
export class HomePage {
  ...
  enviarForm(formulario){
    const fechaa=formulario.form.value.fecha
    const cp = formulario.form.value.cp
    const nombreEncargadoo=formulario.form.value.nombreEncargado
    const telefonoo = formulario.form.value.telefono
    const razon = formulario.form.value.razonSocial
    const dir = formulario.form.value.direcion
    
    this.forncp = cp;
    
    console.log(fechaa);
    console.log(nombreEncargadoo);
    console.log(telefonoo);
    console.log(razon);
    console.log(dir);
    console.log();
